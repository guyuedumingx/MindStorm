...
public class EmailUtil {
    ...
    public static int sendEmail(String to,String head,String content) {
        ...
        props.setProperty("mail.host", "220.181.12.15");
    ...
    public static int sendRegisterEmail(String to, String code){
        String content = "<style type=\"text/css\">\n" +
                ...
                "        <div style=\"position: absolute;top: 0px;left: 0px;width: 100%;height: 120%;background-image: url(http://120.24.111.0/logo.png);background-size: 80%;background-repeat: no-repeat;background-position: center 12px;opacity: 0.1;pointer-events: none;\"></div>\n" +
                "        <div style=\"padding: 5px 20px;background-color: #f3f7f5;\"><img style=\"display: inline-block;width: 22px;vertical-align: middle;\"\n" +
                "                src=\"http://120.24.111.0/logo.png\">\n" +
